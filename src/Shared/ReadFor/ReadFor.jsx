...
const ReadFor = ({title, styles, vendor_name, billing_address_line_1, billing_address_line_2, billing_address_line_3, billing_state, billing_country, shipping_address_line_1, shipping_address_line_2, shipping_address_line_3, shipping_state, shipping_country, trn }) => {
    return (
        <View style={styles.main}>
            <View style={styles.mainLeft}>
                ...
                <View style={styles.mainLeftData}>
                    <Text style={styles.mainLeftCustomer}>{vendor_name}</Text>
