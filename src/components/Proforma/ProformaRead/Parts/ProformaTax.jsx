...
const ProformaTax = ({ styles, currency_abv, currency_conversion_rate, subTotal, discount, tax, total, groupedItems, terms_and_conditions }) => {
    return (
