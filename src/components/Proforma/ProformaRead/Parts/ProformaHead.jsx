...
const ProformaHead = ({ styles, address_line_1, address_line_2, address_line_3, company_name, country, state, trade_license_number, pi_number, pi_date, due_date, reference }) => {
    return (
        <View style={styles.main}>
            ...
            <View style={styles.mainRight}>
                <View style={styles.mainRightData}>
                    <Text>Proforma Number</Text>
                    <Text>Proforma Date</Text>
                    <Text>Due Date</Text>
