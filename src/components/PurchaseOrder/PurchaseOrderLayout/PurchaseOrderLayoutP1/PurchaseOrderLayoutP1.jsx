...
const PurchaseOrderLayoutP1 = ({
    purchaseOrderNumber, setPurchaseOrderNumber,
    orderDate, setOrderDate, paymentTermId, setPaymentTermId,
            ...
            <div className='layout__form--part1-head'>
                ...
                <div className='layout__form--head-info2'>
                    <div className='layout__form--head-info2-data'>
                        <span className='required__field'>PO Number</span>
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                setPurchaseOrderNumber("PO-" + input.substr("PO-".length))
                            }}
                        />
                    </div>
                    <div className='layout__form--head-info2-data'>
                        <span className='required__field'>Order Date</span>
                        <input
                            className='purchase__terms'
                            type="date"
                            name='orderDate'
...
export default PurchaseOrderLayoutP1;
